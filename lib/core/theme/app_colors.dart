...
class AppColors {
  // Primary colors
  static const primaryLight = Color(0xFFDE3730);
  static const primaryDark = Color(0xFFFF5449);
  ...
  // Text colors
  static const textPrimaryLight = Color(0xFF202124);
  ...
  // Success colors
  static const successLight = Color(0xFF0F9D58);
